...
export type AppointmentStatus = "En attente" | "Confirmé" | "Non confirmé" | "Closed" | "Annulé" | "Backlog";
...
export const APPOINTMENT_RESULTS: AppointmentResult[] = [
  "Vente",
  "Soumission envoyée",
  "Refus",
  "À rappeler 3 mois",
...
export const INITIAL_APPOINTMENTS: Appointment[] = [
  ...
  { id: "a2", fullName: "Marie Côté", phone: "(514) 555-0102", address: "567 Boulevard Saint-Laurent", city: "Montréal", date: today, time: "10:30", repId: "rep2", preQual1: "Propriétaire, récemment rénové", preQual2: "Recherche amélioration isolation", notes: "A un chien, sonnette Ring", status: "En attente", source: "Referral", smsScheduled: false, createdAt: today, statusLog: [] },
  ...
  { id: "a4", fullName: "Nathalie Gagnon", phone: "(438) 555-0104", address: "2345 Rue Sherbrooke E", city: "Montréal", date: today, time: "13:00", repId: "rep3", preQual1: "Propriétaire depuis 2018", preQual2: "Veut des soumissions fenêtres", notes: "Appeler avant d'arriver", status: "Non confirmé", source: "Door-to-door", smsScheduled: false, createdAt: today, statusLog: [] },
  { id: "a5", fullName: "Claude Morin", phone: "(514) 555-0105", address: "678 Rue Notre-Dame O", city: "Montréal", date: today, time: "14:00", repId: "rep4", preQual1: "Propriétaire, 3 chambres", preQual2: "Intéressé panneaux solaires", notes: "Stationnement dans l'entrée", status: "En attente", source: "Referral", smsScheduled: false, createdAt: today, statusLog: [] },
  ...
  { id: "a11", fullName: "Robert Paquette", phone: "(514) 555-0111", address: "1800 Rue Ontario E", city: "Montréal", date: yesterday, time: "09:00", repId: "rep1", preQual1: "Propriétaire, bungalow", preQual2: "Imperméabilisation sous-sol", notes: "Complété avec succès", status: "Closed", result: "Vente", source: "Door-to-door", smsScheduled: false, createdAt: yesterday, statusLog: [] },
  { id: "a12", fullName: "Diane Simard", phone: "(438) 555-0112", address: "430 Rue Beaubien E", city: "Montréal", date: yesterday, time: "10:30", repId: "rep2", preQual1: "Oui, propriétaire", preQual2: "Remplacement revêtement", notes: "Non confirmé, replanifier", status: "Non confirmé", source: "Referral", smsScheduled: false, createdAt: yesterday, statusLog: [] },
  { id: "a13", fullName: "Jacques Thibault", phone: "(514) 555-0113", address: "675 Rue Masson", city: "Montréal", date: yesterday, time: "13:00", repId: "rep3", preQual1: "Propriétaire, split-level", preQual2: "Intéressé thermopompe", notes: "Confirmé et complété", status: "Closed", result: "Soumission envoyée", source: "Door-to-door", smsScheduled: false, createdAt: yesterday, statusLog: [] },
